...
file_path = "Daily Plan/weekday dailyplan.csv"
...
predict_data = pd.read_csv('Daily Plan/weekday dailyplan.csv')
...
# predict first-bath
name1_data = pd.read_excel('Daily Plan/weekday-predict-firstbath.xlsx')
...
# predict second-bath
name2_data = pd.read_excel('Daily Plan/weekday-predict-secondbath.xlsx')
...
name3_data = pd.read_excel('Daily Plan/weekday-predict-breakfast.xlsx')
...
name4_data = pd.read_excel('Daily Plan/weekday-predict-lunch.xlsx')
...
name5_data = pd.read_excel('Daily Plan/weekday-predict-dinner.xlsx')
...
name6_data = pd.read_excel('Daily Plan/weekday-predict-clean.xlsx')
...
name7_data = pd.read_excel('Daily Plan/weekday-predict-washclothes.xlsx')
...
name8_data = pd.read_excel('Daily Plan/weekday-predict-footbath.xlsx')
...
# data to csv
predict_data.to_csv('Daily Plan/weekday dailyplan.csv', index=False)