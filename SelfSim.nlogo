...
[
  ...
  "EnergyConsumption/energy-model.nls"
]
...
[
  ...
  ;appliance
  appliance-trigger
  air ;Number of air conditioner [[10 1] [10 1]]
  bread ;Bread machine. If it has a bread machine :[lifespan of bread machine | age of bread machine]; if it has no bread machine []
  induction ;Electromagnetic furnace. If it has a Electromagnetic furnace :[lifespan of electromagnetic furnace | age of electromagnetic furnace]; if it has no electromagnetic furnace []
  rice ;Rice cooker
  ...
  led ; [proportion of LED | lifespan of lights | age of lights]
  ;consumption
  coef ;the degree the annual electricity fee will be adjusted
  electricity ;annual electricity comsumed
  int-cook
  int-cool
]
...
to setup-python
  py:setup "C:/Users/liuju/AppData/Local/Programs/Python/Python39/python.exe"
  (py:run
...
to go
  ...
  school-model
  shop-model
  if year = 2020 [initialize-energy]
  if year >= 2021 [energy-consumption-model]
  ask links [hide-link]
  export-world (word year ".csv")
  output-data
  tick
...
"" ""
PENS
"Total Energy" 1.0 0 -16777216 true "" "plot sum [electricity] of people with [relationship = 1]"
"Average Energy" 1.0 0 -7500403 true "" "plot mean [electricity] of people with [relationship = 1]"
"Int Cook" 1.0 0 -2674135 true "" "plot mean [int-cook] of people with [relationship = 1]"
"Int Cool" 1.0 0 -955883 true "" "plot mean [int-cool] of people with [relationship = 1]"
"ALL-LED" 1.0 0 -6459832 true "" "plot count people with [relationship = 1 and item 0 LED = 4] / count people with [relationship = 1]"
"Above-LED" 1.0 0 -1184463 true "" "plot count people with [relationship = 1 and item 0 LED = 3] / count people with [relationship = 1]"
"Below-LED" 1.0 0 -10899396 true "" "plot count people with [relationship = 1 and item 0 LED = 2] / count people with [relationship = 1]"
"None-LED" 1.0 0 -13840069 true "" "plot count people with [relationship = 1 and item 0 LED = 1] / count people with [relationship = 1]"
